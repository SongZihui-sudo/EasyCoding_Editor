        ...
        if(_kbhit()){
            ...
            switch(ch2){
                ...
                case 72: 
                    ...
                    SetPos(140,39);
                    cout<<"Line:"<<pos_y; 
                    pos_x = page_arr[page_now-1][pos_y-  (page_now-1)*38].size()-1;
                    SetPos(pos_x,pos_y -  (page_now-1)*38);
                    break;   
                //下
                case 80: 
                ...
                //右
                case 77: 
                    if (pos_x>=page_arr[page_now-1][pos_y-  (page_now-1)*38].size()-1) pos_x = page_arr[page_now-1][pos_y-  (page_now-1)*38].size()-1;
                    else pos_x++;
                    SetPos(120,39);
                    cout<<pos_x<<"th"; 
                    SetPos(pos_x,pos_y -  (page_now-1)*38);
